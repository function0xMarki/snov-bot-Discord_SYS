...
import {
  disableChannelAccess,
  enableChannelAccess,
  sendDM,
  sendVerifiedDM,
  sendChannelArrivalMessage,
} from "./src/bot.js";
      ...
      switch (command[0].toLowerCase()) {
        case "!help":
          sendDM(
            ...
            userID,
            DEFAULT,
            "SNOV-bot is a bot designed to verify whether a user is the owner of a specific sentry node collateral address " +
              ...
              "-------------------------------------------------\n\n" +
              "**Other Information**\n\n" +
              "Please follow the link below to learn about the sentry node holder NEVM registry: \n" +
              "> *https://support.syscoin.org/t/nevm-sentrynode-registry/871*",
          );
          break;
        case "!getmessage":
          if (command.length > 1) {
            const { status, message } = await getSigningMessage(
              command[1],
              userID,
            );
            ...
            sendDM(
              ...
              userID,
              FAIL,
              "Missing a collateral transaction ID.",
            );
          }
          break;
        case "!verify":
            ...
            if (collateral.status === SUCCESS && inSnList) {
              ...
              if (verified) {
                ...
                if (added) {
                  ...
                  if (enabled) {
                    sendVerifiedDM(
                      client,
                      userID,
                      `Congratulations, you are now verified and can access sentry node holder channels!\n
                    ...
                    sendDM(
                      ...
                      userID,
                      FAIL,
                      "Could not enable access to all channels.",
                    );
                  }
                } else {
                  sendDM(
                ...
                sendDM(
                  ...
                  userID,
                  FAIL,
                  "Verification failed. Are you sure you entered the information correctly?",
                );
              }
            } else {
              sendDM(
                ...
                userID,
                FAIL,
                "Unspent collateral has not been found or Sentry Node is not active.",
              );
            }
          } else {
            sendDM(
              ...
              userID,
              FAIL,
              "Missing a collateral transaction ID or signed message.",
            );
          }
          break;
        default:
